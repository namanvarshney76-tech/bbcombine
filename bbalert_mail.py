...
def main():
    ...
    CONFIG = {
        'credentials_path': 'D:\\GRN\\Excel\\BigBasket\\credentials.json',  # Path to your Google credentials JSON
        'gdrive_folder_id': '1l5L9IdQ8WcV6AZ04JCeuyxvbNkLPJnHt',  # Optional: Google Drive folder ID to upload to
        'sender': 'alerts@bigbasket.com',  # Email address to search from
        'search_term': 'grn',  # Keywords to search for
        'days_back': 2, # How many days to search
